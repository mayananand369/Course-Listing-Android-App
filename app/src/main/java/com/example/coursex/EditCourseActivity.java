...
public class EditCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (courseRVModal != null) {
            ...
            courseLinkEdt.setText(courseRVModal.getCourseLink());         //need help here
            courseDescEdt.setText(courseRVModal.getCourseDescription());  //need help here
            courseID = courseRVModal.getCourseId();                       //need help here
        }
